 ...
 * the goal of the parser is to take in tokens and determine how to make this tree.
 * This should allow LLVM to compute it's magic and generate the computer code.
 *
 * A problem arrises :
 * - This works fine with functions but how do we set it up for classes
 * ( For my initial compiler version we will not take in account classes and types)
 * 
 ...
 *
 * This makes thing noticeablyy more complex. the task of making the parser will probably
 * be the most advance in the project.
 */
